...
void CMockExpectParameters_GPIO_SetPinValue(CMOCK_GPIO_SetPinValue_CALL_INSTANCE* cmock_call_instance, void* Port, u32 Pin, u8 Value);
void CMockExpectParameters_GPIO_SetPinValue(CMOCK_GPIO_SetPinValue_CALL_INSTANCE* cmock_call_instance, void* Port, u32 Pin, u8 Value)
{
  ...
  memcpy((void*)(&cmock_call_instance->Expected_Value), (void*)(&Value),
         sizeof(u8[sizeof(Value) == sizeof(u8) ? 1 : -1])); /* add u8 to :treat_as_array if this causes an error */
}
